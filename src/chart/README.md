# CHANGELOG
# 2026-03-16 | Copilot | 업그레이드: chart README v4.0. 버전 통일.
# 2026-03-13 | Copilot | 업그레이드: chart matplotlib/ 통합 완료.
# 2026-03-06 | Copilot | 생성: chart README 초안
...
│
└── (docs → docs/chart/)         # 문서 최상위 docs/chart/ 로 이동
...
```python
from src.chart import ChartWidget, MultiChartWidget
...
# 지표 계산
from src.chart.indicators import sma, rsi, macd, bollinger_bands
import pandas as pd
...
# 엔진 사용
from src.chart.engines import LightweightChartEngine, PlotlyChartEngine
...
from src.chart.engines.matplotlib.matplotlib_crosshair import CrosshairController
from src.chart.engines.matplotlib.matplotlib_primitives import draw_candlestick
```
...
기존 코드는 `src.chart.chart`에서 계속 import 가능합니다:

```python
# 기존 방식 (deprecated, 경고 발생)
from src.chart.chart import ChartWidget

# 새 방식 (권장)
from src.chart import ChartWidget
from src.chart.widgets.basic import ChartWidget
```
