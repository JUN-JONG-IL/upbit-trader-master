...
try:
    ...
    if _qtcore_module is None:
        try:
            ...
            _candidates_paths = [
                os.path.join(_project_root, "src", "core", "utils", "qt_stub.py"),
                os.path.join(_project_root, "core", "utils", "qt_stub.py"),
        ...
        if REDIS_AVAILABLE:
            try:
                ...
                try:
                    ...
                    _factory_path = _pl.Path(__file__).resolve().parent.parent.parent / "core" / "database" / "redis_factory.py"
