...
_candidate_modules = (
    "11_server.ui.settings.widget_server_settings",
    "src.11_server.ui.settings.widget_server_settings",
    "11_server.ui.settings.widget_settings",
    "src.11_server.ui.settings.widget_settings",
)
...
if ServerSettingsWidget is None:
    ...
    fallback_candidates = [
        ...
        os.path.join(here, "..", "..", "11_server", "ui", "settings", "widget_server_settings.py"),
        os.path.join(repo_src, "11_server", "ui", "settings", "widget_server_settings.py"),
        os.path.join(repo_src, "src", "11_server", "ui", "settings", "widget_server_settings.py"),
    ]
