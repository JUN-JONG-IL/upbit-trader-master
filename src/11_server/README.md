...
> ⚠️ **중요: 데이터베이스 설정 위치**
>
> 데이터베이스 연결 설정 UI는 **`src/02_data/` 폴더**에 있습니다.
> - TimescaleDB: `src/02_data/timescale/ui/`
> - Redis: `src/02_data/redis/ui/`
> - MongoDB: `src/02_data/mongodb/ui/`
> - Kafka: `src/02_data/kafka/ui/`
> - ClickHouse: `src/02_data/clickhouse/ui/`
> - PostgreSQL: `src/02_data/postgres/ui/`
>
