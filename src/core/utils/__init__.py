...
# -----------------------
# 만약 아직 QtCore가 None 이고, utils.qt_stub 를 src/core/... 처럼 다른 위치에 생성하셨다면
...
if QtCore is None:
    try:
        ...
        candidate_files = [
            ...
            os.path.abspath(os.path.join(here, "..", "core", "utils", "qt_stub.py")),  # src/core/utils/qt_stub.py (your created path)
            os.path.abspath(os.path.join(here, "..", "core", "qt_stub.py")),  # alternative guess
        ]
