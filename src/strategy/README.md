# CHANGELOG
# 2026-03-16 | Copilot | 업그레이드: strategy README v4.0. 버전 통일.
# 2026-03-13 | Copilot | 업그레이드: strategy README v2.0. 전체 템플릿(개요/구조/기능/예시/의존성/참고) 추가.
# 2026-03-06 | Copilot | 생성: strategy README 초안
...
```python
from src._strategy import SignalManager, VolatilityBreakoutStrategy
...
- `src/core/` : 설정 관리, 이벤트 버스, 기본 인프라
- `src/data_01/` : TimescaleDB (OHLCV 데이터), Redis (시그널 캐시)
- `src/chart/indicators/` : 기술 지표 (MA, RSI, MACD 등)
