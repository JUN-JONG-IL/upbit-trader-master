# -*- coding: utf-8 -*-
"""
src/trade 패키지 안전 초기화 (lazy import)
...
사용:
- from src.trade import core  # 런타임 시 core 서브패키지가 동적으로 로드되어 globals에 캐시됨
- import src.trade  # 안전, 즉시 하위 모듈 로드 없음
"""
...
# __all__을 명시하여 from src.trade import * 동작 제어
...
def __getattr__(name: str) -> Any:
    ...
    if name in _EXPORT_MODULES:
        ...
        try:
            ...
            logger.exception("trade 패키지에서 '%s' 서브패키지 로드 실패", name)
