...
def _discover_strategy_and_manager():
    ...
    candidates_manager = ("src.05_strategy.core.signal_manager", "05_strategy.core.signal_manager", "strategy.core.signal_manager", "strategy")
    candidates_various = ("src.05_strategy.strategies.various_indicator", "05_strategy.strategies.various_indicator", "05_strategy.strategies.various_indicator", "strategy.strategies.various_indicator")
    candidates_volatility = ("src.05_strategy.strategies.volatility_breakout", "05_strategy.strategies.volatility_breakout", "strategy.strategies.volatility_breakout")
