# CHANGELOG
# 2026-03-16 | Copilot | 업그레이드: market README v4.0. 폴더명 coinlist/trades 최신화.
# 2026-03-13 | Copilot | 업그레이드: market README v3.0. 한국어 전체 템플릿으로 업그레이드.
...
```python
from src._market import CoinlistWidget, OrderbookWidget, TradeWidget
...
- `src/data_01/redis/` : 실시간 시세 캐시
- `src/data_01/timescale/` : OHLCV 데이터 조회
- PyQt5 : UI 위젯
