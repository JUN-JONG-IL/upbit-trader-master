...
사용법(개발/검증용):
    ...
    python -m src.02_data.gap.status_api --host 127.0.0.1 --port 8080 --redis-url "redis://:dummy@127.0.0.1:58530/0" --timescale-dsn "postgresql://postgres:postgres@localhost:58529/upbit_trader"
