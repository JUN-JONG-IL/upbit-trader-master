...
사용법:
- 단발성 실행(한 번만 처리):
    python -m src.02_data.gap.consumer --once --redis-url "redis://:dummy@127.0.0.1:58530/0" --timescale-dsn "<DSN>"
- 데몬 모드:
    python -m src.02_data.gap.consumer --redis-url "redis://:dummy@127.0.0.1:58530/0" --timescale-dsn "<DSN>"
