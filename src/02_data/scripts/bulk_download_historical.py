...
실행 방법:
    python src/02_data/scripts/bulk_download_historical.py
    python src/02_data/scripts/bulk_download_historical.py --years 4 --symbols KRW-BTC KRW-ETH
...
class BulkHistoricalDownloader:
    ...
    def _build_connector(self):
        ...
        try:
            ...
            ts_db_path = _SRC / "02_data" / "timescale" / "timescale_db.py"
