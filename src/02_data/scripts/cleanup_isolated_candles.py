...
실행 방법:
    ...
    python -m src.02_data.scripts.cleanup_isolated_candles --dry-run

    # 30일 이전 데이터 삭제 (기본값)
    python -m src.02_data.scripts.cleanup_isolated_candles

    # 7일 이전 데이터 삭제
    python -m src.02_data.scripts.cleanup_isolated_candles --before-days 7
