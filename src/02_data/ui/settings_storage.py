# -*- coding: utf-8 -*-
"""
src/02_data/ui/settings_storage.py
...
사용 예:
    from src.02_data.ui.settings_storage import save_setting, load_setting
...
def _get_mongo_collection():
    ...
    """
    try:
        # 프로젝트의 mongo wrapper가 src.02_data.mongodb.mongo_db.MongoConnector 같은 위치에 있다고 가정
        from src.02_data.mongodb.mongo_db import MongoConnector  # type: ignore
