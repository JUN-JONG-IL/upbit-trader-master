...
# README: src/08_portfolio/portfolio
...
### Import Main Widget
```python
from src._08_portfolio.portfolio import PortfolioWidget
...
### Import Optimizer
```python
from src._08_portfolio.portfolio import PortfolioOptimizer
...
```python
from src._08_portfolio.portfolio.logic import (
    PerformanceAnalyzer,
    MarkowitzOptimizer,
    DailyReport,
)
...
python -m src._08_portfolio.portfolio.ui.widget_portfolio

# Test optimizer
python -m src._08_portfolio.portfolio.optimizer
```
