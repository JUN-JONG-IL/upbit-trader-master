...
[통합 내역]
- backup/compute/compute_main.py       → src/compute/engine/
- backup/compute/candle_aggregator.py  → src/compute/engine/
- backup/compute/indicator_engine.py   → src/compute/engine/
- backup/compute/scanner_executor.py   → src/compute/engine/
"""
