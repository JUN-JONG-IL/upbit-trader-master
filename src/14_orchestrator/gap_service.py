...
설명:
- src/02_data/gap/consumer.py의 GapConsumer를 애플리케이션 시작 시 백그라운드로 실행하고,
...
from src.02_data.gap.consumer import create_redis_client, create_timescale_pool, GapConsumer  # type: ignore
