...
def _find_timescale_mod() -> Optional[Any]:
    ...
    for base in here.parents:
        paths = [
            base / "src" / "02_data" / "timescale" / "timescale_redis.py",
            base / "src" / "02_data" / "timescale_redis.py",
            base / "02_data" / "timescale" / "timescale_redis.py",
            base / "src" / "_02_data" / "timescale" / "timescale_redis.py",
