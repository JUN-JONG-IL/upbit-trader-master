...
목적:
- 프로젝트 내의 로컬 구현(src/data_01/redis/health_check.py 등)을 우선 로드하고,
...
try:
    ...
    here = os.path.dirname(__file__)  # 패키지 디렉토리 (예: .../src/data_01/redis)
    candidates = []
    ...
    #    프로젝트 구조에 따라 여러 후보를 시도 (src/data_01/redis, src/redis, redis/)
    candidates.extend([
