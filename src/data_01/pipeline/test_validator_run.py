...
# repo_root: 이 스크립트(src/data_01/pipeline/test_validator_run.py) 기준으로 상위 3단계가 프로젝트 루트
repo_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
validator_path = os.path.join(repo_root, "src", "data_01", "pipeline", "validator.py")
