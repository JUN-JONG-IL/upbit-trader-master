...
def _load_symbol_from_paths(
    ...
    각 후보는 src 디렉토리(찾은 경우) 기준의 상대 경로(예: "02_data/workers/gap_detector.py")
    또는 절대 경로일 수 있습니다.
    """
    for p in candidates:
        # 절대 경로으로 변환
...
_RULE_BASED_CANDIDATES = [
    ...
    "02_data/gap/gap_detector.py",
    "02_data/timescale/operations/gap_detector.py",
...
# 후보: src/06_ai/priority/models/gap_predictor.py
# ---------------------------------------------------------------------
