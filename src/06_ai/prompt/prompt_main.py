"""
[Purpose]
- 콘솔 프롬프트(명령행) 인터페이스/메뉴 및 비동기 제어를 구현.  
- 실시간/잔고/전략/개별조회/전체조회 등 주요 기능 연결

[Responsibilities]
- 프롬프트 메뉴 및 입력 지점(routes) 관리
- (1) 전체가격, (2) 개별가격, (3) 보유목록, (4/5) 전략기동, (8/9) WS제어, (0)종료 등 분기관
- 각 기능별 상세화면·입력대기·리턴 지원

[Main Flow]
- prompt_main() → 반복 입력받음 → 입력값에 따라 각 서비스 호출
"""
...
if __name__ == '__main__':
    from utils.helpers import RealtimeManager, Account
